...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'AutomaticDownload.max_simultaneous_request'
        db.add_column('requester_automaticdownload', 'max_simultaneous_request',
                      self.gf('django.db.models.fields.IntegerField')(default=5),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'AutomaticDownload.max_simultaneous_request'
        db.delete_column('requester_automaticdownload', 'max_simultaneous_request')

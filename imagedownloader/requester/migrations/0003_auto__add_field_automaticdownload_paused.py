...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'AutomaticDownload.paused'
        db.add_column('requester_automaticdownload', 'paused',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'AutomaticDownload.paused'
        db.delete_column('requester_automaticdownload', 'paused')

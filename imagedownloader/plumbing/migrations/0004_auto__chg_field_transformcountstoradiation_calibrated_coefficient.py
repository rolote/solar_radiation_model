...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'TransformCountsToRadiation.calibrated_coefficient'
        db.alter_column('plumbing_transformcountstoradiation', 'calibrated_coefficient', self.gf('django.db.models.fields.DecimalField')(max_digits=5, decimal_places=3))

    def backwards(self, orm):

        # Changing field 'TransformCountsToRadiation.calibrated_coefficient'
        db.alter_column('plumbing_transformcountstoradiation', 'calibrated_coefficient', self.gf('django.db.models.fields.DecimalField')(max_digits=4, decimal_places=2))

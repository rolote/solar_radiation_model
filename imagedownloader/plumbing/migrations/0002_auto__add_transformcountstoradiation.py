...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('plumbing_transformcountstoradiation', (
            ...
            ('calibrated_coefficient', self.gf('django.db.models.fields.DecimalField')(max_digits=4, decimal_places=2)),
            ('space_measurement', self.gf('django.db.models.fields.DecimalField')(max_digits=4, decimal_places=2)),
        ))
    ...
    models = {
        ...
        'plumbing.transformcountstoradiation': {
            ...
            'process_ptr': ('django.db.models.fields.related.OneToOneField', [], {'to': "orm['plumbing.Process']", 'unique': 'True', 'primary_key': 'True'}),
            'space_measurement': ('django.db.models.fields.DecimalField', [], {'max_digits': '4', 'decimal_places': '2'})
        },
        'requester.account': {
